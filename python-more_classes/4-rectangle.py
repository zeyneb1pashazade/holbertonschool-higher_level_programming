...
properties with validation, methods for area and perimeter,
custom string representation (__str__) using '#', and official
string representation (__repr__) for object recreation.
"""
...
class Rectangle:
    ...
    def __repr__(self):
        ...
        a new instance using eval(). Format: Rectangle(width, height).
        """
